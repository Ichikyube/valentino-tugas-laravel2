        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center pl-4">
                    <a class="text-gray-900 no-underline hover:no-underline font-extrabold text-xl" href="{{ route('dashboard') }}">
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-100 md:bg-transparent z-20" id="nav-content">
                    <ul class="list-reset lg:flex justify-end flex-1 items-center">
                        ...
                        <li class="mr-3">
                            <a class="inline-block text-gray-600 no-underline hover:text-gray-900 hover:text-underline py-2 px-4" href="#">Product</a>
                        </li>
                        <li class="mr-3">
